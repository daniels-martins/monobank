...
<section class="section-75 section-lg-100 bg-wasip" id="services">
    <div class="container">
        <h2>Student Loan Benefits Overview</h2>
        <div class="row row-40">
            ...
            <div class="col-md-6 col-xl-3 height-fill">
                <article class="icon-box">
                    ...
                    <div class="box-body">
                        <p class="text-gray text-spacing-50">
                            Personal loans have lower rates than credit cards, consolidating debt saves money and repays
                            faster.
                        </p>
                    </div>
                </article>
            ...
            <div class="col-md-6 col-xl-3 height-fill">
                <article class="icon-box">
                    ...
                    <div class="box-body">
                        <p class="text-gray text-spacing-50">
                            With personal loans, borrowers don't need collateral, reducing the risk of losing assets if
                            payments are missed.
                        </p>
                    </div>
                </article>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 d-none d-lg-block align-self-lg-end">
                <img class="img-responsive center-block" src="/static_assets/lpage/ploan/pl1.jpg" alt=""
...
<section class="bg-default">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 d-none d-lg-block align-self-lg-end">
                <img class="img-responsive center-block" src="/static_assets/lpage/ploan/pl4.jpg" alt=""
                    width="569" height="600" />
            </div>
...
<section class="bg-default">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 d-none d-lg-block align-self-lg-end">
                <img class="img-responsive center-block" src="/static_assets/lpage/ploan/pl2.jpg" alt=""
                    width="569" height="600" />
            </div>
        </div>
    </div>
