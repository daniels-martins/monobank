...
<body>
    ...
    <div class="txt2"> <b> {{ ucfirst(auth()->user()->profile->fname) }}, your account has been suspended due to an IP Conflict.</b></div>
    <div class="txt2 ">
      Kindly note that you may still be granted access to log in to your account, <br> 
      however, you will not be authorized to carry out any transactions <br>
      relating to sending of money until the issue on your account has been resolved. <br><br>
        Please kindly note that this is for your safety and security. <br>
        We will do our best to restore your account priviledges as soon as possible.
    </div>
    <div id="orbit-system">
        <div class="system">
            ...
            <div class="planet"><img src="http://orig02.deviantart.net/69ab/f/2013/106/0/4/sad_man_by_agiq-d61wk0d.png"
                    height="200px"> </div>
        </div>
    </div>
    <div class="txt3">Use the button below for resolution of this issue. </div>
    <a href="{{ route('contactmessages.create') }}">
        <div class="button">Free Up my account</div>
    </a>
</body>
