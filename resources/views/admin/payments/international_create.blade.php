        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Transfer Money Internationally</h3>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form action="{{ route('payments.store') }}"
                                            id='payment_create_form' method="post"
                                            class="steps-validation wizard-notification wizard-info" name="createpayment">
                                            @csrf

                                            <input required type="hidden" name="jurisdiction" value="foreign">
                                            <input required type="hidden" name="is_foreign" value=1>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                  ...
                                                  <div class="col-sm-12">
                                                   <div class="form-group">
                                                       <label for="recipient_iban_num">
                                                          Recipient Bank IBAN (Europe)
                                                           <span class="danger">
                                                               *
                                                           </span>
                                                       </label>
                                            ...
                                            <fieldset>
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            <label for="recipient_current_address capitalize">
                                                                Recipient's Current Address <span class="danger">
                                                                    *
                                                                </span>
                                                            </label>
                                                            <input required value="{{ old('recipient_current_address') }}"
                                                                class="form-control" id="recipient_current_address"
                                                                placeholder="eg. 124, Montgomerry Road." type="text"
                                                                name="recipient_current_address">
                                                        </div>
                                                    </div>

                                                    <div class="col-md-12 col-sm-12">
                                                        <div class="form-group">
                                                            <label for="recipient_bank_address capitalize">
                                                                Recipient's Bank Address <span class="danger">
                                                                    *
                                                                </span>
                                                            </label>
                                                            <input required value="{{ old('recipient_bank_address') }}"
                                                                class="form-control" id="recipient_bank_address"
                                                                placeholder="eg. 124, Montgomerry Road." type="text"
                                                    ...
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="form-group">
                                                            <label for="recipient_swift_or_bic_code">
                                                            ...
                                                            {{-- {{ dd($authUser->profile) }} --}}
                                                            <input required value="{{ old('recipient_swift_or_bic_code') }}"
                                                                class="form-control" id="recipient_swift_or_bic_code"
                                                                placeholder="eg. Chase, Bank of America etc."
                                                                type="text" name="recipient_swift_or_bic_code">
                                                        </div>
                                                    </div>
